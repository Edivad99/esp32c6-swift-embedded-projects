...
struct MatterTemperatureSensor: MatterConreteEndpoint {
...
struct MatterHumiditySensor: MatterConreteEndpoint {
  static var deviceTypeId: UInt32 {
  ...
  var humidityMeasurement: HumidityMeasurement {
    cluster(.humidityMeasurement)
  }
}

struct MatterPressureSensor: MatterConreteEndpoint {
  static var deviceTypeId: UInt32 {
